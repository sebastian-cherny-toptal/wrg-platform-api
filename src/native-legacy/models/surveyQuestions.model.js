...
const surveyQuestionSchema = new mongoose.Schema({
    Id: {type: mongoose.Schema.Types.Number}, //Id of a survey question.
    ...
    QuestionTypeId: {type: mongoose.Schema.Types.Number, index: true}, // The id of the question type.
    ...
    PageNumber: {type: mongoose.Schema.Types.Number}, // The page number of which the question is shown.
    OrderNumber: {type: mongoose.Schema.Types.Number}, // The order of the question within the page or within the parent question.
