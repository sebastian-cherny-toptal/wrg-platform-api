# Baton Rouge production test fixture
...
The deployment seed reads the XLSX files from this archive. Do not replace it
with the raw survey exports because those contain confidential row-level data.
